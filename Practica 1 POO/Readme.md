...
Se ha creado un Script con un color público para modificarlo desde el editor, un float público para modificar el tamaño del cubo y dos booleanos públicos para indicar si el cubo se moverá y/o cambiará de escala en tiempo de ejecución.
